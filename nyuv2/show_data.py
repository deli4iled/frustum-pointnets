...
def demo(data_idx):
    ...
    objects_gt = dataset.get_label_gt_objects(data_idx)
    #objects[2].print_object()    
    #objects_gt[2].print_object()
    
    #objects[3].print_object()    
    #objects_gt[3].print_object()
    
    #objects[4].print_object()    
    #objects_gt[4].print_object()
